...
CLASS lcl_model DEFINITION INHERITING FROM zcl_mvcfw_base_salv_model.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_outtab,
             chkbox TYPE flag.
             INCLUDE TYPE spfli.
             INCLUDE TYPE zcl_mvcfw_base_salv_model=>ty_incl_outtab_ext.
...
*      me->xxx( ).
  ...
  METHOD _get_demo_sub01_data.
    IF mv_evt_params-evt_list-row_double_click IS NOT INITIAL.
      READ TABLE mt_outtab INTO DATA(ls_outtab) INDEX mv_evt_params-evt_list-row_double_click.
      IF sy-subrc EQ 0.
        SELECT * FROM sflight
