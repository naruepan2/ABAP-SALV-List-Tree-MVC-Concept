...
public section.
  ...
  data MO_MODEL type ref to ZCL_MVCFW_BASE_MODEL read-only .
  ...
  methods CREATE_NEW_VIEW_INSTANCE
    importing
      ...
      !IO_TREE_VIEW type ref to ZCL_MVCFW_BASE_SALV_TREE_VIEW optional
      !IR_EVENT_LIST type ref to ZCL_MVCFW_BASE_MODEL=>TY_EVT_LIST_PARAM optional
      !IR_EVENT_TREE type ref to ZCL_MVCFW_BASE_MODEL=>TY_EVT_TREE_PARAM optional
