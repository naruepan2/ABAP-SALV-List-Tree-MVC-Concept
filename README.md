# ABAP List Viewer with MVC Concept by using class CL_SALV_TABLE 
## Overview
...
The framework consists of the following repo objects:
  ...
  3. The model class ZCL_MVCFW_BASE_MODEL. A program will define its own main model inheriting from this class to manipulate any data of this model.
  4. The screen class ZCL_MVCFW_BASE_SSCR. It will manipulate selection screen that handle the PBO and PAI and so on.  
